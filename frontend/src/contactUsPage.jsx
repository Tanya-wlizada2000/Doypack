...
export const ContactForm = () => {
  ...
  console.log(t("contactName.label"))
  return (
    <>
        ...
        <div className="itemsContainer">
          ...
          <div className="contactHeading">
            <div className="contactPageText">
              ...
              <div className="contactPageText">
                <h2>{t("email.label")}</h2>
                <Link to="/"> info@doypack.org</Link>
              </div>
              <div className="contactPageText">
              <h2>{t("tel.label")}</h2>
              <Link to="/" className="links"> Tel: +8617 813 089921 </Link> 
              <br />
              <Link to="/" className="links"> Whatsapp/WeChat: +8617 813 089921</Link>
              </div>
            </div>
            <div className="map">
              <iframe
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form">
                  ...
                  <div className="textArea">
                    <div>
                      <textarea
                        placeholder={t("contactMessage.label")}
                        name="describe"
